...
function AssistantTab() {
  ...
  const onRefresh = async () => {
    setRefreshing(true)
    try {
      // Force a heavy-snapshot rebuild (rate-limited server-side), then refresh.
