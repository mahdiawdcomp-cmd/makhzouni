...
function CatalogCategoriesManager() {
  ...
  // Per-category: expanded (shows inline type editor) and pending new type input
      ...
      <CardContent className="p-5 space-y-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="اسم الفئة الجديدة (مثال: مشروبات)"
            value={newName}
