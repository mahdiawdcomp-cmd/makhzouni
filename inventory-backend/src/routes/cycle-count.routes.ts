...
router.patch("/:id/items", authMiddleware, requirePermission("INVENTORY_MANAGE"), validate(cycleCountUpdateItemSchema), updateItem);
router.post("/:id/submit", authMiddleware, requirePermission("INVENTORY_MANAGE"), submitSession);
router.post("/:id/close", authMiddleware, requirePermission("INVENTORY_MANAGE"), validate(cycleCountCloseSchema), closeSession);
...
router.post("/:id/items/:itemId/approve", authMiddleware, requirePermission("INVENTORY_MANAGE"), validate(cycleCountApproveItemSchema), approveItem);
router.post("/:id/items/:itemId/reject", authMiddleware, requirePermission("INVENTORY_MANAGE"), rejectItem);
router.post("/:id/approve-all", authMiddleware, requirePermission("INVENTORY_MANAGE"), validate(cycleCountApproveAllSchema), approveAllItems);
