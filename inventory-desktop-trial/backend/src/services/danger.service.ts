...
export async function wipeOperationalData(confirmPhrase: string): Promise<WipeResult> {
  ...
  await prisma.$transaction([
    ...
    prisma.productWarehouseStock.deleteMany(),
